...
Author:		Salvatore Balzano, Marco Milanesio
Date:		2013.10.10
...
function createHAR(address, title, startTime, elaspedTime, resources)
{
    ...
    resources.forEach(function (resource) {
        ...
        //        if (header.name.toLowerCase()=='httpid') {
        //                console.log(header.name + ':' + header.value);
        //            }
        //        });
        //console.log('startReply.bodySize: ' + startReply.bodySize);
        //startReply.headers.forEach(function (header) {
        //            if (header.name.toLowerCase()=='content-length') {
        //                resource.size = parseInt(header.value);
        //                console.log('start header: ' + header.name + ',' + resource.size);
        //            }
        //        });
        //endReply.headers.forEach(function (header) {
        //            if (header.name.toLowerCase()=='content-length') {
        //                resource.size = parseInt(header.value);
        //                console.log('end header: ' + header.name + ',' + resource.size);
        //            }
        //        });
        realsize = getRealSize(startReply) || startReply.bodySize;
        //console.log('---')
...
//#########
    //when moving to phantomJS 2.0.0
